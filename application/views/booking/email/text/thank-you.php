...
This is an automated e-mail to confirm that you have registered <?php echo count($group->attendees); ?> attendees to attend Womble 2012.  You need to pay a £5 non-refundable deposit by 29th February 2012.  The remaining £30 per person is due by 1st June 2012.  Please make cheques payable to "Leicestershire Scout Council" and write "Womble #<?php echo $group->id; ?>" on the reverse.  Send your cheques to:
